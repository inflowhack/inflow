...
//         0xE7d93AEE00757Da0bdb3eaB4D3E142D79B64DA9f;
...
//         console.log("webAuthn", webAuthnAddr);
...
//             );
//         console.log("webAuthnAccountFactory", address(webAuthnAccountFactory));
...
//         console.log("paymaster owner", msg.sender);

//         // Deploy the Polaroid NFT
//         PolaroidNFT polaroidNFT = new PolaroidNFT();
//         console.log("POLAROID NFT", address(polaroidNFT));
